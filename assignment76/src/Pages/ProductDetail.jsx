...
import {withCart} from "../Components/HOC/WithPorvider";
          ...
          <div className="h-[90%] w-[80vw] sm:w-[450px] md:w-[600px] md:h-[650px] lg:h-[450px] lg:w-[1000px] border-2 border-black rounded-xl p-5 flex justify-around bg-white flex-col lg:flex-row gap-1">
            ...
            <div className="lg:w-[50%]  w-full lg:py-2 p-0">
              ...
              <div className="mt-6 flex w-full gap-2">
                <div className=" w-[10%] lg:h-[35px] h-[45px]  border border-black p-1  rounded-md flex items-center justify-center pl-2">
                  <input
                    className="border-0 border-[#d2d2d2]  w-full  h-6   rounded-md pl-1"
                    type="number"
                    min={1}
                    value={quant ||1}
                    max={99}
